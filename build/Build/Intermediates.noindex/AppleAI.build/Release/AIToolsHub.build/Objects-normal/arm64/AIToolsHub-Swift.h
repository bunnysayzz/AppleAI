...
#ifndef AITOOLSHUB_SWIFT_H
#define AITOOLSHUB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AIToolsHub",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10AIToolsHub11AppDelegate")
...
SWIFT_CLASS("_TtC10AIToolsHub14MenuBarManager")
@interface MenuBarManager : NSObject <NSMenuDelegate>
- (void)handleStatusItemClick:(NSStatusBarButton * _Nonnull)sender;
- (void)togglePopupWindow;
- (void)handleOpenServiceNotification:(NSNotification * _Nonnull)notification;
...
@interface MenuBarManager (SWIFT_EXTENSION(AIToolsHub)) <NSWindowDelegate>
...
SWIFT_CLASS("_TtC10AIToolsHub12RecorderView")
@interface RecorderView : NSView
...
SWIFT_CLASS("_TtC10AIToolsHub18WebViewCoordinator")
@interface WebViewCoordinator : NSObject <WKNavigationDelegate, WKUIDelegate>
- (void)webView:(WKWebView * _Nonnull)webView didFinishNavigation:(WKNavigation * _Null_unspecified)navigation;
- (void)webView:(WKWebView * _Nonnull)webView didStartProvisionalNavigation:(WKNavigation * _Null_unspecified)navigation;
- (void)webView:(WKWebView * _Nonnull)webView didFailNavigation:(WKNavigation * _Null_unspecified)navigation withError:(NSError * _Nonnull)error;
- (void)webView:(WKWebView * _Nonnull)webView runJavaScriptAlertPanelWithMessage:(NSString * _Nonnull)message initiatedByFrame:(WKFrameInfo * _Nonnull)frame completionHandler:(void (^ _Nonnull)(void))completionHandler;
...
SWIFT_CLASS("_TtC10AIToolsHub24WebViewHostingController")
@interface WebViewHostingController : NSViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)loadView;
- (void)viewDidAppear;
